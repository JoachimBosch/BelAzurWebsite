        ...
        <>
            <div className="mx-auto px-4 pt-28">
                <div className="flex flex-col items-center text-center">
                    <h1 className="mb-4">
                        Build Your Brand’s Presence in the Palm of Your
                        Customers’ Hands
                    </h1>
                    ...
                    <p>
                        ...
                        <br />
                        Whether you want to create a food ordering app,
                        streamline your booking process, or launch something
                        entirely unique,
                        <br /> we design and build apps that are fast, reliable,
                        and easy to use.
                        <br />
                ...
                >
                    <div className="border my-12 p-4">
                        ...
                        <div className="mx-auto ">
                            ...
                            wanting to connect with customers through mobile
                            <br />
                            <FontAwesomeIcon icon={faCheck} /> Companies looking
                            to streamline processes
                            <br />
                            <FontAwesomeIcon icon={faCheck} /> Brands with
                            unique app ideas that require a tailored experience
                            <br />
                            <FontAwesomeIcon icon={faCheck} /> Startups aiming
                            for efficient development and long-term scalability
                            <br />
                        </div>
                    </div>
                    <div className="border my-12 p-4">
                        <h2>Benefits</h2>
                        <div className="mx-auto ">
                            <FontAwesomeIcon icon={faCheck} /> Keep customers
                            connected with your business anytime, anywhere
                            <br />
                            <FontAwesomeIcon icon={faCheck} /> Automate
                            bookings, payments, and other key functions for
                            improved efficiency
                            <br />
                            <FontAwesomeIcon icon={faCheck} /> One app that
                            works perfectly on both iOS and Android
                            <br />
                            <FontAwesomeIcon icon={faCheck} /> A user-friendly
                            app keeps customers coming back
                            <br />
                        </div>
                    </div>
                </div>
